...
export const todoCreate = ({todoitem, todoDescription, isdone}) => {
  ...
  return dispatch => {
    firebase
      ...
      .push({todoitem, todoDescription, isdone})
      .then(() => {
...
export const todoSave = ({todoitem, todoDescription, isdone, uid}) => {
  const {currentUser} = firebase.auth();
  ...
  return dispatch => {
    firebase
      ...
      .set({todoitem, todoDescription, isdone})
      .then(() => {
